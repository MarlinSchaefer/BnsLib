...
from ..utils import input_to_list, list_length
from ..utils import progress_tracker, mp_progress_tracker
from ..types import DictList, NamedPSDCache
    ...
    if psd_name.lower() == 'simple':
        ...
        for i in range(number):
            ...
            noise = pycbc.noise.reproduceable.colored_noise(psd,
                                                            ...
                                                            low_frequency_cutoff=flow)  # noqa: E501
            try:
        ...
        for i in indices:
            ...
            if self.detectors is None:
                ...
                if 'pol' in params:
                    ...
                    pol_key = 'pol'
                    params['pol'] = 0.
                projection_params.append([params[key] for key in [ra_key,
                                                                  dec_key,
                                                                  pol_key]])
